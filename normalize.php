...
?>
                    <div class="font30" style="color:#808080;font-weight:bold">音量が小さいファイルも、均一に。</div>
                    <div class="center">
                    ...
                    このページでは、ノーマライズ機能を使う方法を説明します。<br>
                ...
                <div class="font26" style="margin-top:40px;margin-bottom:20px;font-weight:bold">ノーマライズ機能を使ってみよう。</div>
                <div style="margin-left:20px">
                    聞々ハヤえもんには音量を正規化することができる「ノーマライズ」機能がついています。音量がばらばらなファイルを持っている場合などに便利な機能です。<br>
                    <br>
                    この機能を使うには、エフェクト ⇒ ノーマライズメニューをクリックし、メニューを選択します。
                </div>
                <div id="navi">
