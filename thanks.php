<?php
$set['PageTitle'] = '聞々ハヤえもんのダウンロードが完了しました！';
$set['column'] = 'one';
$set['type'] = 'manual';
...
?>
                        ...
                        <div id='div-gpt-ad-1361584819763-1' style='width:728px; height:90px;'>
                            <script type='text/javascript'>
                                googletag.cmd.push(function () {
                                    googletag.display('div-gpt-ad-1361584819763-1');
                                });
                            </script>
                        </div>
                    </div>
                ...
                <div class="font26" style="margin-top:40px;font-weight:bold">ＳＮＳでダウンロード報告。</div>
                <div class="font18" style="margin-top:15px;margin-bottom:20px;font-weight:bold;color:#808080">
                    新しいバージョンを、友だちにも。
                </div>
                <div style="margin-left:20px">
                    聞々ハヤえもんの最新版をダウンロードしたことを友だちにも伝えましょう。<br>
                    <br>
                ...
                <div class="font26" style="margin-top:40px;font-weight:bold">取扱い説明書。</div>
                <div class="font18" style="margin-top:15px;margin-bottom:20px;font-weight:bold;color:#808080">
                    ソフトを使い始める、原点となる場所。
                </div>
                <div style="margin-left:20px">
                ...
                <div class="font18" style="margin-top:15px;margin-bottom:20px;font-weight:bold;color:#808080">
                    何気ない「ありがとう」が、最大のモチベーションに。
                </div>
                <div style="margin-left:20px">
                    もし聞々ハヤえもんを気に入っていただけたら、感想をお聞かせください。<br>
                    <br>
                ...
                <div class="center">
                    ...
                    <div id='div-gpt-ad-1361584819763-0' style='width:728px; height:90px;'>
                        <script type='text/javascript'>
                            googletag.cmd.push(function () {
                                googletag.display('div-gpt-ad-1361584819763-0');
                            });
                        </script>
                    </div>
                </div>
