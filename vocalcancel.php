<?php
$set['PageTitle'] = 'ボーカルキャンセル機能を使ってみよう';
$set['column'] = 'one';
$set['type'] = 'manual';
...
?>
                    <div class="font30" style="color:#808080;font-weight:bold">ボーカルを小さくすることで、カラオケを楽しむ。</div>
                    <div class="center">
                    ...
                    このページでは、ボーカルキャンセル機能を使う方法を説明します。<br>
                    聞々ハヤえもんをご存知無い方は、まず以下のページをご覧ください。<br>
                    <a class="btn" href="about.php">聞々ハヤえもんについて</a><br>
                    まだ聞々ハヤえもんをダウンロードしていない方は、以下のページをご覧ください。<br>
                    <a class="btn" href="howtodownload.php">聞々ハヤえもんをダウンロードする方法</a>
                </div>
                <div class="font26" style="margin-top:40px;margin-bottom:20px;font-weight:bold">ボーカルキャンセル機能を使ってみよう。</div>
                <div style="margin-left:20px">
                    聞々ハヤえもんにはボーカル音を小さくすることができる「ボーカルキャンセル機能」がついています。カラオケを楽しみたい時や、ボーカル以外の音を聴き取りたい時に便利な機能です。<br>
                    <br>
                    この機能を使うには、エフェクト ⇒ ボーカルキャンセルメニューをクリックし、メニューを選択します。
                </div>
                <div id="navi">
